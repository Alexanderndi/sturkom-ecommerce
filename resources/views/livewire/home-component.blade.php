                            ...
                            <div class="row align-items-center slider-animated-1">
                                <div class="col-lg-5 col-md-6">
                                    <div class="hero-slider-content-2">
                                        <h4 class="animated">{{$slidder->top_title}}</h4>
                                        <h2 class="animated fw-900">{{$slidder->title}}</h2>
                                        <h1 class="animated fw-900 text-brand">{{$slidder->sub_title}}</h1>
                                        <p class="animated">{{$slidder->offer}}</p>
                                        <a class="animated btn btn-brush btn-brush-3" href="{{$slidder->link}}"> Shop Now </a>
                                    </div>
                                </div>
                                <div class="col-lg-7 col-md-6">
                                    <div class="single-slider-img single-slider-img-1">
                                        <img class="animated slider-1-1" src="{{asset('assets/imgs/sliders')}}/{{$slidder->image}}" alt="{{$slidder->title}}">
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="product-cart-wrap mb-30">
                                        <div class="product-img-action-wrap">
                                            <div class="product-img product-img-zoom">
                                                <a href="{{ route('product.details',['slug'=>$featured_product->slug]) }}">
                                                    <img class="default-img" src="{{ asset('assets/imgs/products')}}/{{$featured_product->image}}" alt="{{$featured_product->name}}">
                                                    <img class="hover-img" src="{{ asset('assets/imgs/products')}}/{{$featured_product->image}}" alt="{{$featured_product->name}}">
                                                </a>
                                            </div>
                                        ...
                                        <div class="product-content-wrap">
                                            <div class="product-category">
                                                <a href="{{route('product.category', ['slug'=>$featured_product->category->slug])}}">{{$featured_product->category->name}}</a>
                                            </div>
                                            <h2><a href="{{ route('product.details',['slug'=>$featured_product->slug]) }}">{{$featured_product->name}}</a></h2>
                                            ...
                                            <div class="product-price">
                                                ...
                                                <span class="old-price">${{$featured_product->sale_price}}</span>
                                            </div>
                                            <div class="product-action-1 show">
                                                <a aria-label="Add To Cart" class="action-btn hover-up" href="#" wire:click.prevent="store({{$featured_product->id}},'{{$featured_product->name}}',{{$featured_product->regular_price}})"><i class="fi-rs-shopping-bag-add"></i></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-3 col-md-4 col-sm-6 col-xs-6 col-6">
                                    <div class="product-cart-wrap mb-30">
                                        <div class="product-img-action-wrap">
                                            <div class="product-img product-img-zoom">
                                                <a href="{{ route('product.details',['slug'=>$featured_product->slug]) }}">
                                                    <img class="default-img" src="{{ asset('assets/imgs/products')}}/{{$latest_product->image}}" alt="">
                                                    <img class="hover-img" src="{{ asset('assets/imgs/products')}}/{{$latest_product->image}}" alt="">
                                                </a>
                                            </div>
                                            {{-- <div class="product-action-1">
                                                <a aria-label="Quick view" class="action-btn hover-up" data-bs-toggle="modal" data-bs-target="#quickViewModal"><i class="fi-rs-eye"></i></a>
                                        ...
                                        <div class="product-content-wrap">
                                            <div class="product-category">
                                                <a href="{{route('product.category', ['slug'=>$latest_product->category->slug])}}">{{$latest_product->category->name}}</a>
                                            </div>
                                            <h2><a href="{{ route('product.details',['slug'=>$latest_product->slug]) }}">{{$latest_product->name}}</a></h2>
                                            <div class="rating-result" title="90%">
                                                <span>
                                                    <span>90%</span>
                                                </span>
                                            ...
                                            <div class="product-price">
                                                ...
                                                <span class="old-price">${{$latest_product->sale_price}}</span>
                                            </div>
                                            <div class="product-action-1 show">
                                                <a aria-label="Add To Cart" class="action-btn hover-up" href="cart.html"><i class="fi-rs-shopping-bag-add"></i></a>
                                            </div>
                        ...
                        @foreach ($product_categories as $product_category)
                            <div class="card-1">
                                <figure class=" img-hover-scale overflow-hidden">
                                    <a href="{{ route('product.category', ['slug'=>$product_category->slug])}}"><img src="{{ asset('assets/imgs/categories')}}/{{$product_category->image}}" alt="{{$product_category->name}}"></a>
                                </figure>
                                <h5><a href="{{ route('product.category', ['slug'=>$product_category->slug])}}">{{$product_category->name}}</a></h5>
                            </div>
                        @endforeach
                    </div>
                </div>
